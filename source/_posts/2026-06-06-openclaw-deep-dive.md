...
<svg viewBox="0 0 680 580" width="100%" xmlns="http://www.w3.org/2000/svg" role="img" aria-label="OpenClaw 系统架构图"><defs><style>text{font-family:sans-serif}.title{font-size:16px;font-weight:bold}.label{font-size:13px;font-weight:bold}.body{font-size:12px}.caption{font-size:11px;fill:#666}</style><marker id="arrow" markerWidth="8" markerHeight="8" refX="4" refY="4" orient="auto"><path d="M0,0 L8,4 L0,8 Z" fill="#94A3B8"/></marker></defs><rect width="680" height="580" fill="#FAFAFA" rx="8"/><text x="340" y="28" text-anchor="middle" class="title" fill="#222">OpenClaw 系统架构</text><rect x="20" y="45" width="640" height="95" fill="#EFF6FF" rx="6" stroke="#3B82F6" stroke-width="1.5"/><text x="340" y="65" text-anchor="middle" class="label" fill="#1E40AF">输入层：22+ 消息通道</text><text x="35" y="85" class="caption" fill="#3B82F6">WhatsApp</text><text x="110" y="85" class="caption" fill="#3B82F6">Telegram</text><text x="185" y="85" class="caption" fill="#3B82F6">WeChat / QQ</text><text x="270" y="85" class="caption" fill="#3B82F6">Discord / Slack</text><text x="360" y="85" class="caption" fill="#3B82F6">飞书</text><text x="410" y="85" class="caption" fill="#3B82F6">Google Chat</text><text x="500" y="85" class="caption" fill="#3B82F6">Signal / iMessage</text><text x="35" y="105" class="caption" fill="#3B82F6">Microsoft Teams / Matrix / LINE / Mattermost / Nextcloud Talk / Nostr / IRC / Zalo / Twitch</text><text x="35" y="125" class="caption" fill="#64748B">每个通道由对应 adapter 驱动（grammY for Telegram / Baileys for WhatsApp / 微信 SDK 等）</text><line x1="340" y1="142" x2="340" y2="158" stroke="#94A3B8" stroke-width="2" marker-end="url(#arrow)"/><rect x="20" y="160" width="640" height="100" fill="#FEF3C7" rx="6" stroke="#D97706" stroke-width="1.5"/><text x="340" y="180" text-anchor="middle" class="label" fill="#92400E">Gateway（端口 18789，WebSocket 协议）</text><rect x="35" y="193" width="175" height="55" fill="#FFFBEB" rx="4" stroke="#D97706" stroke-width="0.5"/><text x="122" y="213" text-anchor="middle" class="body" fill="#92400E">消息路由</text><text x="122" y="230" text-anchor="middle" class="caption">DM配对 → Session分发</text><text x="122" y="244" text-anchor="middle" class="caption">多Agent路由策略</text><rect x="230" y="193" width="175" height="55" fill="#FFFBEB" rx="4" stroke="#D97706" stroke-width="0.5"/><text x="317" y="213" text-anchor="middle" class="body" fill="#92400E">命令队列</text><text x="317" y="230" text-anchor="middle" class="caption">per-session 串行化</text><text x="317" y="244" text-anchor="middle" class="caption">steer/followup/collect/interrupt</text><rect x="425" y="193" width="220" height="55" fill="#FFFBEB" rx="4" stroke="#D97706" stroke-width="0.5"/><text x="535" y="213" text-anchor="middle" class="body" fill="#92400E">生命周期管理</text><text x="535" y="230" text-anchor="middle" class="caption">health/heartbeat/presence</text><text x="535" y="244" text-anchor="middle" class="caption">cron调度 + Webhook触发</text><line x1="122" y1="262" x2="122" y2="288" stroke="#94A3B8" stroke-width="2" marker-end="url(#arrow)"/><line x1="535" y1="262" x2="535" y2="288" stroke="#94A3B8" stroke-width="2" marker-end="url(#arrow)"/><rect x="20" y="290" width="640" height="115" fill="#F5F3FF" rx="6" stroke="#7C3AED" stroke-width="1.5"/><text x="340" y="310" text-anchor="middle" class="label" fill="#5B21B6">Agent Runtime 执行层</text><rect x="35" y="323" width="300" height="70" fill="#EDE9FE" rx="4" stroke="#7C3AED" stroke-width="0.5"/><text x="185" y="341" text-anchor="middle" class="body" fill="#5B21B6">OpenClaw 原生 Runtime</text><text x="185" y="358" text-anchor="middle" class="caption">while-loop: context → model → tool → persist</text><text x="185" y="373" text-anchor="middle" class="caption">生命周期事件: lifecycle / assistant / tool</text><text x="185" y="388" text-anchor="middle" class="caption">自动压缩 + 超时保护（默认48h）</text><rect x="355" y="323" width="290" height="70" fill="#EDE9FE" rx="4" stroke="#7C3AED" stroke-width="0.5"/><text x="500" y="341" text-anchor="middle" class="body" fill="#5B21B6">外部 Harness 适配</text><text x="365" y="358" class="caption">Codex（OpenAI 订阅）</text><text x="365" y="373" class="caption">Copilot（GitHub Copilot CLI）</text><text x="365" y="388" class="caption">Claude CLI / Gemini CLI / OpenCode / Cursor（ACP协议）</text><line x1="185" y1="407" x2="185" y2="428" stroke="#94A3B8" stroke-width="2" marker-end="url(#arrow)"/><line x1="500" y1="407" x2="500" y2="428" stroke="#94A3B8" stroke-width="2" marker-end="url(#arrow)"/><rect x="20" y="430" width="640" height="65" fill="#F0FDF4" rx="6" stroke="#16A34A" stroke-width="1.5"/><text x="340" y="450" text-anchor="middle" class="label" fill="#15803D">插件 & 工具层</text><text x="35" y="470" class="caption" fill="#15803D">MCP（Server+Client）</text><text x="175" y="470" class="caption" fill="#15803D">Skills（agentskills.io）</text><text x="310" y="470" class="caption" fill="#15803D">ClawHub 插件市场</text><text x="425" y="470" class="caption" fill="#15803D">Canvas（A2UI）</text><text x="530" y="470" class="caption" fill="#15803D">Cron / Webhooks</text><text x="35" y="488" class="caption" fill="#64748B">代码插件（运行时hook）+ Bundle插件（Skills/MCP打包）→ npm分发</text><line x1="340" y1="497" x2="340" y2="513" stroke="#94A3B8" stroke-width="2" marker-end="url(#arrow)"/><rect x="20" y="515" width="640" height="50" fill="#EFF6FF" rx="6" stroke="#3B82F6" stroke-width="1.5"/><text x="340" y="535" text-anchor="middle" class="label" fill="#1E40AF">配套应用（可选）</text><text x="35" y="555" class="caption" fill="#3B82F6">Windows Hub</text><text x="140" y="555" class="caption" fill="#3B82F6">macOS 菜单栏</text><text x="240" y="555" class="caption" fill="#3B82F6">iOS Node</text><text x="315" y="555" class="caption" fill="#3B82F6">Android Node</text><text x="410" y="555" class="caption" fill="#3B82F6">WebChat</text><text x="480" y="555" class="caption" fill="#3B82F6">Voice Wake / Talk</text></svg>
