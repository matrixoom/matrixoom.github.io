...
<svg viewBox="0 0 600 200" xmlns="http://www.w3.org/2000/svg" style="display:block;margin:20px auto;max-width:100%;">
  ...
  <!-- 第一根K线 -->
  <rect x="80" y="100" width="30" height="60" fill="#e74c3c" rx="1"/>
  <line x1="95" y1="100" x2="95" y2="85" stroke="#aaa" stroke-width="1.5"/>
  <line x1="95" y1="160" x2="95" y2="175" stroke="#aaa" stroke-width="1.5"/>
  <text x="95" y="190" fill="#aaa" font-size="10" font-family="sans-serif" text-anchor="middle">昨日</text>
  <!-- 缺口区域 -->
  <rect x="130" y="70" width="60" height="30" fill="#f39c12" opacity="0.3" rx="2"/>
  <text x="160" y="90" fill="#f39c12" font-size="11" font-family="sans-serif" text-anchor="middle">缺口</text>
  <!-- 第二根K线 -->
  <rect x="210" y="40" width="30" height="70" fill="#e74c3c" rx="1"/>
  <line x1="225" y1="40" x2="225" y2="25" stroke="#aaa" stroke-width="1.5"/>
  <line x1="225" y1="110" x2="225" y2="120" stroke="#aaa" stroke-width="1.5"/>
  <text x="225" y="190" fill="#aaa" font-size="10" font-family="sans-serif" text-anchor="middle">今日</text>
  <!-- 标注线 -->
  <line x1="110" y1="85" x2="210" y2="85" stroke="#f39c12" stroke-width="1" stroke-dasharray="4,3"/>
  <text x="300" y="150" fill="#e0e0e0" font-size="12" font-family="sans-serif">今日最低价 > 昨日最高价 = 向上缺口</text>
</svg>
...
<svg viewBox="0 0 700 280" xmlns="http://www.w3.org/2000/svg" style="display:block;margin:20px auto;max-width:100%;">
  ...
  <!-- 横盘区 -->
  <polyline points="40,180 70,170 100,175 130,165 160,170" fill="none" stroke="#888" stroke-width="1.5"/>
  <!-- 普通缺口 -->
  <rect x="160" y="140" width="20" height="25" fill="#95a5a6" opacity="0.5" rx="1"/>
  <text x="170" y="135" fill="#95a5a6" font-size="9" text-anchor="middle">普通缺口</text>
  <polyline points="180,165 210,155 240,160" fill="none" stroke="#888" stroke-width="1.5"/>
  <!-- 突破缺口 -->
  <rect x="240" y="110" width="25" height="35" fill="#e74c3c" opacity="0.4" rx="1"/>
  <text x="252" y="105" fill="#e74c3c" font-size="9" text-anchor="middle">突破缺口</text>
  <polyline points="265,155 300,120 340,100 380,90" fill="none" stroke="#e74c3c" stroke-width="2"/>
  <!-- 持续缺口 -->
  <rect x="380" y="55" width="25" height="30" fill="#e74c3c" opacity="0.4" rx="1"/>
  <text x="392" y="50" fill="#e74c3c" font-size="9" text-anchor="middle">持续缺口</text>
  <polyline points="405,85 440,70 480,55 520,50" fill="none" stroke="#e74c3c" stroke-width="2"/>
  <!-- 竭尽缺口 -->
  <rect x="520" y="25" width="25" height="20" fill="#f39c12" opacity="0.5" rx="1"/>
  <text x="532" y="20" fill="#f39c12" font-size="9" text-anchor="middle">竭尽缺口</text>
  <polyline points="545,45 580,60 620,90 650,130" fill="none" stroke="#2ecc71" stroke-width="2"/>
  <!-- 回补箭头 -->
  <path d="M650,130 Q620,150 580,140" fill="none" stroke="#f39c12" stroke-width="1.5" stroke-dasharray="4,3"/>
  <text x="620" y="165" fill="#f39c12" font-size="10">回补缺口</text>
  <!-- 标题 -->
  <text x="350" y="260" fill="#e0e0e0" font-size="13" font-family="sans-serif" text-anchor="middle">上涨过程中的四种缺口及其演变</text>
</svg>
