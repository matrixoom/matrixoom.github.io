...
> 知道"是什么"让你赚钱，知道"为什么"让你持续赚钱。缺口表面上是价格图表上的一个现象，但其背后是市场结构、参与者行为和供需关系的综合体现。理解底层原理，才能在千变万化的市场中灵活应用，而不是死记硬背。

#### 5.1.1 信息不对称：缺口的第一推动力

缺口的本质是**价格在某个区间内没有任何成交**。为什么会这样？

想一想开盘前的情况：隔夜（对于A股来说是15:00到次日9:30）积累了大量信息——美股涨跌、政策新闻、公司公告、宏观经济数据等。这些信息一夜之间涌入市场。

**如果大多数人看完信息后看法一致**，都认为明天应该涨，就会出现这样的情况：
- 买方愿意以比今天最高价更高的价格买入
- 卖方不愿意以比今天最低价更低的价格卖出
- 结果：明日开盘价直接跳空开到更高位置，两天的价格之间出现了一个无人成交的真空地带——**这就是向上缺口**

向下缺口同理，只是方向相反。

**关键推论**：缺口是信息不对称 + 预期一致的自然结果。所以：
- 政策利好/利空消息发布后的第一个交易日最容易出缺口
- 年报季、重大黑天鹅事件后也经常出现缺口
- 这也是为什么**集合竞价阶段**（9:15-9:25）经常能看到价格剧烈波动

#### 5.1.2 供需结构：缺口不回补的深层原因

为什么有些缺口永远不回补（比如2008年金融危机后的某些跳空），而有些缺口三天就补？

**不回补的缺口 = 供需结构发生了根本性改变**

以突破缺口为例：当一只股票长期在10-12元横盘，突然一天放量突破12元——这不是简单的价格上涨，而是：
1. 在12元上方积累了**大量套牢盘**（很多人曾在12元买入被套）
2. 突破12元意味着这些套牢盘终于解套，他们可能会卖出
3. 但如果突破后买盘依然汹涌（放量），说明市场整体对这个股票的定价达成了新的共识
4. 新的供需平衡点已经上移，12元从"天花板"变成了"地板"（支撑）

**被回补的缺口 = 供需结构没有真的改变**

普通缺口出现在横盘整理中。横盘意味着多空力量暂时平衡，股价在某个区间内来回波动。普通缺口只是因为某天信息刺激让价格短暂偏离了这个平衡区间，但由于没有新的供需格局变化，价格很快又回到原来的区间——**缺口被回补**。

#### 5.1.3 行为金融学：缺口背后的人性弱点

缺口理论之所以有效，核心在于**市场参与者的行为模式具有可预测的规律性**：

**① 后悔规避与缺口加速**

当一只股票出现突破缺口后，还没买入的人会感到后悔（"早知道就该买！"）。这种后悔心理会推动他们在价格更高时追入，而不是等待回调。追入行为进一步推高价格，形成正反馈循环——这就是**持续缺口**出现并不断扩大的心理基础。

**② 处置效应与竭尽缺口**

竭尽缺口的形成往往伴随着散户的"集体狂欢"。在趋势末端，很多人是这样操作的：
- 持仓的人看到利润丰厚，**兑现利润**的冲动越来越强
- 持仓轻的人看到别人赚钱，**FOMO（错失恐惧）** 驱动追高买入
- 两股力量在高位碰撞，换手剧烈，成交量放出天量

但此时，**先知先觉的聪明资金已经在悄悄撤退**。竭尽缺口出现时，实际上是散户在高位接盘。

**③ 锚定效应与缺口回补**

人的大脑喜欢"锚定"——用一个已知的价格作为参照。缺口回补本质上就是锚定效应的体现：
- 突破缺口不补：市场形成了新的价格共识，原来的阻力变成了支撑
- 竭尽缺口必补：因为原来的价格"锚点"被证明是错误的，市场需要重新定价

#### 5.1.4 市场结构：缺口与流动性

还有一个被很多人忽略的底层因素——**流动性分布**。

在某个价格区间，如果原来积累了大量的成交（无论买还是卖），这个区间就形成了"流动性池"。价格一旦离开这个区间，在缺口区域：

- 买方不知道该在哪里设置止损
- 卖方不知道该在哪里止盈
- 机构投资者的算法交易系统可能出现异常

这就是为什么**放量突破缺口**比缩量突破更可靠——有足够的流动性支持新的价格发现过程。

反过来，竭尽缺口出现时，成交量往往异常放大（A股中常见"天量见天价"），正是因为大量筹码在高位换手，而这种换手本身就是趋势即将衰竭的信号。

#### 5.1.5 综合框架：四缺口的行为对应

理解了底层原理再看四种缺口，会有更深的认识：

| 缺口类型 | 信息层面 | 供需结构 | 行为层面 |
|---------|---------|---------|---------|
| **普通缺口** | 随机噪音，无新信息 | 横盘整理，结构未变 | 短期投机者博弈，很快被套利填平 |
| **突破缺口** | 重大信息改变预期 | 供需格局根本性转变 | 后悔规避驱动追涨，趋势确认信号 |
| **持续缺口** | 趋势确认，惯性强化 | 供不应求或供过于求持续 | FOMO驱动，趋势加速，市场情绪高涨 |
| **竭尽缺口** | 信息已被过度反应 | 边际买家减少，边际卖家增加 | 处置效应 + FOMO最后狂欢，聪明钱撤退 |

**核心结论**：缺口不只是一个技术分析工具，它是市场信息、供需关系和人类行为共同作用的结果。理解"为什么"，能让你在看到缺口时，判断它是哪种缺口、是否会回补、是否应该操作——而不仅仅是机械地套用口诀。
...
<svg viewBox="0 0 700 380" xmlns="http://www.w3.org/2000/svg" style="display:block;margin:20px auto;max-width:100%;">
  ...
  <line x1="460" y1="88" x2="490" y2="88" stroke="#f39c12" stroke-width="1" stroke-dasharray="3,2"/>
  <rect x="460" y="72" width="30" height="16" fill="#e74c3c" opacity="0.2"/>
  <text x="475" y="65" fill="#f39c12" font-size="9" font-family="sans-serif" text-anchor="middle">耗竭缺口</text>
  <text x="475" y="56" fill="#aaa" font-size="8" font-family="sans-serif" text-anchor="middle">（顶部附近）</text>
  <polyline points="490,65 505,68 520,80 535,95 550,115 565,140 580,165 595,185 615,205" fill="none" stroke="#f1c40f" stroke-width="2"/>
  <!-- 底部标签 -->
  <text x="92" y="350" fill="#f39c12" font-size="10" font-family="sans-serif" text-anchor="middle">① 普通缺口</text>
  <text x="222" y="350" fill="#e74c3c" font-size="10" font-family="sans-serif" text-anchor="middle">② 突破缺口</text>
  <text x="357" y="350" fill="#e74c3c" font-size="10" font-family="sans-serif" text-anchor="middle">③ 持续缺口</text>
  <text x="500" y="350" fill="#f39c12" font-size="10" font-family="sans-serif" text-anchor="middle">④ 耗竭缺口</text>
  <text x="92" y="365" fill="#aaa" font-size="9" font-family="sans-serif" text-anchor="middle">会被回补</text>
  <text x="222" y="365" fill="#aaa" font-size="9" font-family="sans-serif" text-anchor="middle">不易回补</text>
  <text x="357" y="365" fill="#aaa" font-size="9" font-family="sans-serif" text-anchor="middle">不易回补</text>
  <text x="500" y="365" fill="#aaa" font-size="9" font-family="sans-serif" text-anchor="middle">会被回补</text>
</svg>
