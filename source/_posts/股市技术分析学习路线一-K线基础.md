...
<svg viewBox="0 0 700 360" xmlns="http://www.w3.org/2000/svg" style="display:block;margin:20px auto;max-width:100%;">
  ...
  <!-- 价格→Y: Y=290-(P-86)*6 -->
  <!-- 横盘区K线 price 90-92 -->
  <rect x="30" y="224" width="18" height="20" fill="#e74c3c" rx="1"/>
  <line x1="39" y1="224" x2="39" y2="214" stroke="#aaa" stroke-width="1"/>
  <line x1="39" y1="244" x2="39" y2="254" stroke="#aaa" stroke-width="1"/>
  <rect x="55" y="230" width="18" height="16" fill="#2ecc71" rx="1"/>
  <line x1="64" y1="230" x2="64" y2="220" stroke="#aaa" stroke-width="1"/>
  <line x1="64" y1="246" x2="64" y2="256" stroke="#aaa" stroke-width="1"/>
  <rect x="80" y="226" width="18" height="18" fill="#e74c3c" rx="1"/>
  <line x1="89" y1="226" x2="89" y2="218" stroke="#aaa" stroke-width="1"/>
  <line x1="89" y1="244" x2="89" y2="254" stroke="#aaa" stroke-width="1"/>
  <text x="70" y="275" fill="#888" font-size="9" text-anchor="middle">横盘</text>
  <!-- ===== 普通缺口 ===== -->
  <rect x="110" y="206" width="18" height="16" fill="#e74c3c" rx="1"/>
  <line x1="119" y1="206" x2="119" y2="196" stroke="#aaa" stroke-width="1"/>
  <line x1="119" y1="222" x2="119" y2="232" stroke="#aaa" stroke-width="1"/>
  <!-- 普通缺口水平色带: 昨日H=91→Y218, 今日L=92.5→Y209 -->
  <rect x="40" y="209" width="140" height="9" fill="#95a5a6" opacity="0.5" rx="2"/>
  <text x="155" y="198" fill="#95a5a6" font-size="9">普通缺口</text>
  <!-- 回补 -->
  <rect x="140" y="216" width="18" height="18" fill="#2ecc71" rx="1"/>
  <line x1="149" y1="216" x2="149" y2="206" stroke="#aaa" stroke-width="1"/>
  <line x1="149" y1="234" x2="149" y2="244" stroke="#aaa" stroke-width="1"/>
  <text x="149" y="260" fill="#888" font-size="8" text-anchor="middle">回补</text>
  <!-- ===== 突破缺口 ===== -->
  <rect x="180" y="158" width="18" height="24" fill="#e74c3c" rx="1"/>
  <line x1="189" y1="158" x2="189" y2="140" stroke="#aaa" stroke-width="1"/>
  <line x1="189" y1="182" x2="189" y2="196" stroke="#aaa" stroke-width="1"/>
  <!-- 突破缺口水平色带: 昨日H=93→Y206, 今日L=95→Y194 -->
  <rect x="40" y="188" width="175" height="18" fill="#e74c3c" opacity="0.35" rx="2"/>
  <text x="195" y="180" fill="#e74c3c" font-size="9">突破缺口</text>
  <text x="195" y="192" fill="#f39c12" font-size="8">放量</text>
  <!-- 上涨K线 -->
  <rect x="215" y="128" width="18" height="22" fill="#e74c3c" rx="1"/>
  <line x1="224" y1="128" x2="224" y2="110" stroke="#aaa" stroke-width="1"/>
  <line x1="224" y1="150" x2="224" y2="160" stroke="#aaa" stroke-width="1"/>
  <rect x="245" y="104" width="18" height="18" fill="#e74c3c" rx="1"/>
  <line x1="254" y1="104" x2="254" y2="86" stroke="#aaa" stroke-width="1"/>
  <line x1="254" y1="122" x2="254" y2="132" stroke="#aaa" stroke-width="1"/>
  <!-- ===== 持续缺口 ===== -->
  <rect x="280" y="74" width="18" height="20" fill="#e74c3c" rx="1"/>
  <line x1="289" y1="74" x2="289" y2="56" stroke="#aaa" stroke-width="1"/>
  <line x1="289" y1="94" x2="289" y2="104" stroke="#aaa" stroke-width="1"/>
  <!-- 持续缺口水平色带: 昨日H=97→Y152, 今日L=99→Y140 -->
  <rect x="40" y="116" width="260" height="24" fill="#e74c3c" opacity="0.35" rx="2"/>
  <text x="280" y="108" fill="#e74c3c" font-size="9">持续缺口</text>
  <text x="280" y="120" fill="#f39c12" font-size="8">加速</text>
  <!-- 上涨K线 -->
  <rect x="315" y="56" width="18" height="16" fill="#e74c3c" rx="1"/>
  <line x1="324" y1="56" x2="324" y2="38" stroke="#aaa" stroke-width="1"/>
  <line x1="324" y1="72" x2="324" y2="82" stroke="#aaa" stroke-width="1"/>
  <rect x="345" y="44" width="18" height="14" fill="#e74c3c" rx="1"/>
  <line x1="354" y1="44" x2="354" y2="28" stroke="#aaa" stroke-width="1"/>
  <line x1="354" y1="58" x2="354" y2="68" stroke="#aaa" stroke-width="1"/>
  <!-- ===== 竭尽缺口 ===== -->
  <rect x="380" y="32" width="18" height="12" fill="#e74c3c" rx="1"/>
  <line x1="389" y1="32" x2="389" y2="18" stroke="#aaa" stroke-width="1"/>
  <line x1="389" y1="44" x2="389" y2="54" stroke="#aaa" stroke-width="1"/>
  <!-- 竭尽缺口水平色带: 昨日H=101→Y104, 今日L=103→Y92 -->
  <rect x="40" y="68" width="350" height="24" fill="#f39c12" opacity="0.35" rx="2"/>
  <text x="370" y="62" fill="#f39c12" font-size="9">竭尽缺口</text>
  <!-- 最后一根小阳线 -->
  <rect x="415" y="26" width="18" height="10" fill="#e74c3c" rx="1"/>
  <line x1="424" y1="26" x2="424" y2="16" stroke="#aaa" stroke-width="1"/>
  <line x1="424" y1="36" x2="424" y2="46" stroke="#aaa" stroke-width="1"/>
  <!-- ===== 回补走势 ===== -->
  <rect x="450" y="38" width="18" height="16" fill="#2ecc71" rx="1"/>
  <line x1="459" y1="38" x2="459" y2="28" stroke="#aaa" stroke-width="1"/>
  <line x1="459" y1="54" x2="459" y2="64" stroke="#aaa" stroke-width="1"/>
  <rect x="480" y="56" width="18" height="22" fill="#2ecc71" rx="1"/>
  <line x1="489" y1="56" x2="489" y2="44" stroke="#aaa" stroke-width="1"/>
  <line x1="489" y1="78" x2="489" y2="88" stroke="#aaa" stroke-width="1"/>
  <rect x="510" y="80" width="18" height="28" fill="#2ecc71" rx="1"/>
  <line x1="519" y1="80" x2="519" y2="68" stroke="#aaa" stroke-width="1"/>
  <line x1="519" y1="108" x2="519" y2="118" stroke="#aaa" stroke-width="1"/>
  <rect x="540" y="110" width="18" height="32" fill="#2ecc71" rx="1"/>
  <line x1="549" y1="110" x2="549" y2="98" stroke="#aaa" stroke-width="1"/>
  <line x1="549" y1="142" x2="549" y2="152" stroke="#aaa" stroke-width="1"/>
  <!-- 回补箭头 -->
  <text x="490" y="175" fill="#f39c12" font-size="10" text-anchor="middle">↓ 回补竭尽缺口 ↓</text>
  <!-- 图例 -->
  <rect x="560" y="200" width="130" height="120" fill="#252b3d" rx="5"/>
  <text x="625" y="218" fill="#e0e0e0" font-size="10" text-anchor="middle" font-weight="bold">图例</text>
  <rect x="570" y="228" width="20" height="8" fill="#95a5a6" opacity="0.5" rx="1"/>
  <text x="600" y="236" fill="#aaa" font-size="9">普通缺口</text>
  <rect x="570" y="248" width="20" height="8" fill="#e74c3c" opacity="0.35" rx="1"/>
  <text x="600" y="256" fill="#aaa" font-size="9">突破/持续缺口</text>
  <rect x="570" y="268" width="20" height="8" fill="#f39c12" opacity="0.35" rx="1"/>
  <text x="600" y="276" fill="#aaa" font-size="9">竭尽缺口</text>
  <rect x="570" y="288" width="12" height="12" fill="#e74c3c" rx="1"/>
  <text x="590" y="298" fill="#aaa" font-size="9">阳线</text>
  <rect x="620" y="288" width="12" height="12" fill="#2ecc71" rx="1"/>
  <text x="640" y="298" fill="#aaa" font-size="9">阴线</text>
  <!-- 标题 -->
  <text x="350" y="340" fill="#e0e0e0" font-size="13" font-family="sans-serif" text-anchor="middle">上涨过程中的四种缺口及其演变</text>
  <text x="350" y="356" fill="#888" font-size="10" font-family="sans-serif" text-anchor="middle">色带 = 缺口（今日最低价 &gt; 昨日最高价之间的价格真空）</text>
</svg>
