...
<!-- 渲染层次：①背景 ②参考线 ③K线身体(半透明) ④色带(上方,不透明) ⑤上影线+标注 -->
<!-- 价格→Y: Y=260-(P-85)*9 验证：P=100→95, P=102→47, P=103→38 -->

<!-- ===== 普通缺口 ===== -->
<text x="95" y="18" fill="#e0e0e0" font-size="11" font-family="sans-serif" text-anchor="middle" font-weight="bold">普通缺口</text>
<!-- 昨K线 H=100,L=95,O=97,C=98 → Y_H=95, Y_L=158, Y_O=113, Y_C=122 -->
<line x1="35" y1="95" x2="35" y2="83" stroke="#aaa" stroke-width="1.5"/>
<rect x="23" y="113" width="24" height="9" fill="#e74c3c" opacity="0.7" rx="1"/>
<line x1="35" y1="158" x2="35" y2="166" stroke="#aaa" stroke-width="1.5"/>
<text x="35" y="178" fill="#aaa" font-size="8" text-anchor="middle">昨</text>
<!-- 今K线 H=102,L=98,O=99,C=100 → Y_H=47, Y_L=122, Y_O=113, Y_C=104 -->
<line x1="95" y1="83" x2="95" y2="47" stroke="#aaa" stroke-width="1.5"/>
<rect x="83" y="83" width="24" height="21" fill="#e74c3c" opacity="0.7" rx="1"/>
<line x1="95" y1="104" x2="95" y2="122" stroke="#aaa" stroke-width="1.5"/>
<text x="95" y="178" fill="#aaa" font-size="8" text-anchor="middle">今</text>
<!-- 昨高参考线 P=100→Y=95，今低参考线 P=102→Y=47 -->
<line x1="10" y1="95" x2="130" y2="95" stroke="#95a5a6" stroke-width="1.5" stroke-dasharray="5,3"/>
<text x="133" y="99" fill="#95a5a6" font-size="8">昨高=100</text>
<line x1="10" y1="47" x2="130" y2="47" stroke="#95a5a6" stroke-width="1.5" stroke-dasharray="5,3"/>
<text x="133" y="51" fill="#95a5a6" font-size="8">今低=102</text>
<!-- 缺口色带：在参考线之间，K线上方 -->
<rect x="12" y="47" width="126" height="48" fill="#95a5a6" opacity="0.5" rx="3"/>
<text x="70" y="75" fill="#fff" font-size="11" text-anchor="middle" font-weight="bold">缺口</text>
<text x="70" y="222" fill="#95a5a6" font-size="9" text-anchor="middle">很快回补</text>

<!-- ===== 突破缺口 ===== -->
<text x="265" y="18" fill="#e0e0e0" font-size="11" font-family="sans-serif" text-anchor="middle" font-weight="bold">突破缺口</text>
<!-- 昨K线 H=100,L=95,O=97,C=98 → Y_H=95, Y_L=158 -->
<line x1="205" y1="95" x2="205" y2="83" stroke="#aaa" stroke-width="1.5"/>
<rect x="193" y="113" width="24" height="9" fill="#e74c3c" opacity="0.7" rx="1"/>
<line x1="205" y1="158" x2="205" y2="166" stroke="#aaa" stroke-width="1.5"/>
<text x="205" y="178" fill="#aaa" font-size="8" text-anchor="middle">昨</text>
<!-- 今K线 H=105,L=102,O=103,C=104 → Y_H=20, Y_L=47 -->
<line x1="265" y1="47" x2="265" y2="20" stroke="#aaa" stroke-width="1.5"/>
<rect x="253" y="47" width="24" height="12" fill="#e74c3c" opacity="0.7" rx="1"/>
<line x1="265" y1="59" x2="265" y2="47" stroke="#aaa" stroke-width="1.5"/>
<text x="265" y="178" fill="#aaa" font-size="8" text-anchor="middle">今</text>
<!-- 昨高参考线 P=100→Y=95，今低参考线 P=102→Y=47 -->
<line x1="180" y1="95" x2="300" y2="95" stroke="#e74c3c" stroke-width="1.5" stroke-dasharray="5,3"/>
<text x="303" y="99" fill="#e74c3c" font-size="8">昨高=100</text>
<line x1="180" y1="47" x2="300" y2="47" stroke="#e74c3c" stroke-width="1.5" stroke-dasharray="5,3"/>
<text x="303" y="51" fill="#e74c3c" font-size="8">今低=102</text>
<!-- 缺口色带 -->
<rect x="182" y="47" width="116" height="48" fill="#e74c3c" opacity="0.5" rx="3"/>
<text x="240" y="75" fill="#fff" font-size="11" text-anchor="middle" font-weight="bold">缺口</text>
<text x="265" y="222" fill="#e74c3c" font-size="9" text-anchor="middle">放量·不回补</text>

<!-- ===== 持续缺口 ===== -->
<text x="435" y="18" fill="#e0e0e0" font-size="11" font-family="sans-serif" text-anchor="middle" font-weight="bold">持续缺口</text>
<!-- 昨K线 H=103,L=100,O=101,C=102 → Y_H=77, Y_L=104 -->
<line x1="375" y1="77" x2="375" y2="65" stroke="#aaa" stroke-width="1.5"/>
<rect x="363" y="95" width="24" height="9" fill="#e74c3c" opacity="0.7" rx="1"/>
<line x1="375" y1="104" x2="375" y2="112" stroke="#aaa" stroke-width="1.5"/>
<text x="375" y="178" fill="#aaa" font-size="8" text-anchor="middle">昨</text>
<!-- 今K线 H=106,L=103,O=104,C=105 → Y_H=20, Y_L=38 -->
<line x1="435" y1="38" x2="435" y2="20" stroke="#aaa" stroke-width="1.5"/>
<rect x="423" y="38" width="24" height="12" fill="#e74c3c" opacity="0.7" rx="1"/>
<line x1="435" y1="50" x2="435" y2="38" stroke="#aaa" stroke-width="1.5"/>
<text x="435" y="178" fill="#aaa" font-size="8" text-anchor="middle">今</text>
<!-- 昨高参考线 P=103→Y=77，今低参考线 P=103→Y=38 -->
<line x1="350" y1="77" x2="470" y2="77" stroke="#3498db" stroke-width="1.5" stroke-dasharray="5,3"/>
<text x="473" y="81" fill="#3498db" font-size="8">昨高=103</text>
<line x1="350" y1="38" x2="470" y2="38" stroke="#3498db" stroke-width="1.5" stroke-dasharray="5,3"/>
<text x="473" y="42" fill="#3498db" font-size="8">今低=103</text>
<!-- 缺口色带 -->
<rect x="352" y="38" width="116" height="39" fill="#3498db" opacity="0.5" rx="3"/>
<text x="410" y="60" fill="#fff" font-size="11" text-anchor="middle" font-weight="bold">缺口</text>
<text x="435" y="222" fill="#3498db" font-size="9" text-anchor="middle">加速·趋势中段</text>

<!-- ===== 竭尽缺口 ===== -->
<text x="605" y="18" fill="#e0e0e0" font-size="11" font-family="sans-serif" text-anchor="middle" font-weight="bold">竭尽缺口</text>
<!-- 昨K线 H=103,L=100,O=101,C=102 → Y_H=77, Y_L=104 -->
<line x1="545" y1="77" x2="545" y2="65" stroke="#aaa" stroke-width="1.5"/>
<rect x="533" y="95" width="24" height="9" fill="#e74c3c" opacity="0.7" rx="1"/>
<line x1="545" y1="104" x2="545" y2="112" stroke="#aaa" stroke-width="1.5"/>
<text x="545" y="178" fill="#aaa" font-size="8" text-anchor="middle">昨</text>
<!-- 今K线 H=106,L=103,O=104,C=105 → Y_H=20, Y_L=38 -->
<line x1="605" y1="38" x2="605" y2="20" stroke="#aaa" stroke-width="1.5"/>
<rect x="593" y="38" width="24" height="12" fill="#e74c3c" opacity="0.7" rx="1"/>
<line x1="605" y1="50" x2="605" y2="38" stroke="#aaa" stroke-width="1.5"/>
<text x="605" y="178" fill="#aaa" font-size="8" text-anchor="middle">今</text>
<!-- 昨高参考线 P=103→Y=77，今低参考线 P=103→Y=38 -->
<line x1="520" y1="77" x2="640" y2="77" stroke="#f39c12" stroke-width="1.5" stroke-dasharray="5,3"/>
<text x="643" y="81" fill="#f39c12" font-size="8">昨高=103</text>
<line x1="520" y1="38" x2="640" y2="38" stroke="#f39c12" stroke-width="1.5" stroke-dasharray="5,3"/>
<text x="643" y="42" fill="#f39c12" font-size="8">今低=103</text>
<!-- 缺口色带 -->
<rect x="522" y="38" width="116" height="39" fill="#f39c12" opacity="0.5" rx="3"/>
<text x="580" y="60" fill="#fff" font-size="11" text-anchor="middle" font-weight="bold">缺口</text>
<!-- 回补K线 -->
<rect x="633" y="77" width="22" height="45" fill="#2ecc71" opacity="0.8" rx="1"/>
<line x1="644" y1="77" x2="644" y2="67" stroke="#aaa" stroke-width="1.5"/>
<line x1="644" y1="122" x2="644" y2="132" stroke="#aaa" stroke-width="1.5"/>
<text x="658" y="100" fill="#f39c12" font-size="8">回补</text>
<text x="605" y="222" fill="#f39c12" font-size="9" text-anchor="middle">反转·开始回补</text>

<!-- 图例 -->
<rect x="15" y="246" width="670" height="28" fill="#252b3d" rx="4"/>
<rect x="30" y="253" width="18" height="10" fill="#95a5a6" opacity="0.5" rx="1"/>
<text x="55" y="262" fill="#aaa" font-size="9">普通缺口</text>
<rect x="140" y="253" width="18" height="10" fill="#e74c3c" opacity="0.5" rx="1"/>
<text x="165" y="262" fill="#aaa" font-size="9">突破缺口</text>
<rect x="260" y="253" width="18" height="10" fill="#3498db" opacity="0.5" rx="1"/>
<text x="285" y="262" fill="#aaa" font-size="9">持续缺口</text>
<rect x="370" y="253" width="18" height="10" fill="#f39c12" opacity="0.5" rx="1"/>
<text x="395" y="262" fill="#aaa" font-size="9">竭尽缺口</text>
<text x="560" y="262" fill="#888" font-size="9">色带=今低&gt;昨高之间的价格真空</text>
</svg>
