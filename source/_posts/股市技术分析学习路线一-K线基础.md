...
<svg viewBox="0 0 600 280" xmlns="http://www.w3.org/2000/svg" style="display:block;margin:20px auto;max-width:100%;">
  ...
  <!-- 上升趋势线：连接低点L1-L2-L3 -->
  <line x1="40" y1="200" x2="200" y2="160" stroke="#3498db" stroke-width="2" stroke-dasharray="6,3"/>
  <line x1="200" y1="160" x2="320" y2="60" stroke="#3498db" stroke-width="2" stroke-dasharray="6,3" opacity="0.5"/>
  <!-- 低点标注 -->
  <circle cx="40" cy="200" r="4" fill="#2ecc71"/>
  <text x="35" y="220" fill="#2ecc71" font-size="11" font-weight="bold">L1</text>
  <circle cx="120" cy="190" r="4" fill="#2ecc71"/>
  <text x="115" y="210" fill="#2ecc71" font-size="11" font-weight="bold">L2</text>
  <circle cx="200" cy="160" r="4" fill="#2ecc71"/>
  <text x="195" y="180" fill="#2ecc71" font-size="11" font-weight="bold">L3</text>
  <!-- 高点标注 -->
  ...
  <!-- 上升趋势线标注 -->
  <text x="100" y="195" fill="#3498db" font-size="10">上升趋势线</text>
  <!-- 下降趋势 -->
  ...
  <!-- 下降趋势线：连接高点H1-H2-H3 -->
  <line x1="350" y1="60" x2="510" y2="110" stroke="#3498db" stroke-width="2" stroke-dasharray="6,3"/>
  <line x1="510" y1="110" x2="580" y2="155" stroke="#3498db" stroke-width="2" stroke-dasharray="6,3" opacity="0.5"/>
  <!-- 高点标注 -->
  <circle cx="350" cy="60" r="4" fill="#e74c3c"/>
  <text x="345" y="45" fill="#e74c3c" font-size="11" font-weight="bold">H1</text>
  <circle cx="430" cy="75" r="4" fill="#e74c3c"/>
  <text x="425" y="60" fill="#e74c3c" font-size="11" font-weight="bold">H2</text>
  <circle cx="510" cy="110" r="4" fill="#e74c3c"/>
  <text x="505" y="95" fill="#e74c3c" font-size="11" font-weight="bold">H3</text>
  <!-- 低点标注 -->
  ...
  <!-- 下降趋势线标注 -->
  <text x="420" y="70" fill="#3498db" font-size="10">下降趋势线</text>
  <!-- 图例 -->
  <text x="300" y="265" fill="#aaa" font-size="11" font-family="sans-serif" text-anchor="middle">上升趋势线连接低点(L) | 下降趋势线连接高点(H)</text>
</svg>
